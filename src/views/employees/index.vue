    ...
    <div class="app-container">
      ...
      <PageTool>
        ...
        <template slot="after">
          ...
          <el-button size="small" type="primary" icon="el-icon-plus" :disabled="!checkPermission('POINT-USER-ADD')" @click="showDialog=true">增加新员工</el-button>
          <!-- 添加新员工的 对话框 -->
          <AddNewEm
      ...
      <el-card>
        <el-table :data="rows">
          ...
          <el-table-column label="操作" width="350">
            <template slot-scope="scope">
              <el-button size="mini" :disabled="!checkPermission('POINT-USER-UPDATE')" @click="$router.push(`/detail/${scope.row.id}`)">查看</el-button>
              ...
              <el-button size="mini" :disabled="!checkPermission('POINT-USER-DELETE')" @click.native="delEmployee(scope.row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!-- 分页 -->
